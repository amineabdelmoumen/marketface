          ...
          <div className="row">
            <div className="col-10 offset-2">
              ...
              <div className="form-boxes">
                ...
                <div>
                  <label htmlFor="matiere"
                         className={`border rounded px-2 cursor-pointer ${findElement('matière première', catalogue.matiere) ? 'bg-secondary text-white': 'text-black-50'}`}>
                    matière première
                ...
                <div>
                  <label htmlFor="transformation"
                         className={`border rounded px-2 cursor-pointer ${findElement('transformation', catalogue.matiere) ? 'bg-secondary text-white': 'text-black-50'}`}>
                    transformation
                ...
                <div>
                  <label htmlFor="distribution"
                         className={`border rounded px-2 cursor-pointer ${findElement('distribution', catalogue.matiere) ? 'bg-secondary text-white': 'text-black-50'}`}>
                    distribution
                ...
                <div>
                  <label htmlFor="revendeur"
                         className={`border rounded px-2 cursor-pointer ${findElement('revendeur', catalogue.matiere) ? 'bg-secondary text-white': 'text-black-50'}`}>
                    revendeur
              ...
              <div className="form-boxes">
                ...
                <div>
                  <label htmlFor="b2b"
                         className={`border rounded px-2 cursor-pointer ${findElement('B2B', catalogue.business) ? 'bg-secondary text-white': 'text-black-50'}`}>
                    B2B
                ...
                <div>
                  <label htmlFor="b2c"
                         className={`border rounded px-2 cursor-pointer ${findElement('B2C', catalogue.business) ? 'bg-secondary text-white': 'text-black-50'}`}>
                    B2C
                ...
                <div>
                  <label htmlFor="b2g"
                         className={`border rounded px-2 cursor-pointer ${findElement('B2G', catalogue.business) ? 'bg-secondary text-white': 'text-black-50'}`}>
                    B2G
              ...
              <div className="form-boxes">
                ...
                <div>
                  <label htmlFor="offshore"
                         className={`border rounded px-2 cursor-pointer ${findElement('Offshore', catalogue.location) ? 'bg-secondary text-white': 'text-black-50'}`}>
                    Offshore
                ...
                <div>
                  <label htmlFor="onshore"
                         className={`border rounded px-2 cursor-pointer ${findElement('Onshore', catalogue.location) ? 'bg-secondary text-white': 'text-black-50'}`}>
                    Onshore
                ...
                <div>
                  <label htmlFor="nearshore"
                         className={`border rounded px-2 cursor-pointer ${findElement('Nearshore', catalogue.location) ? 'bg-secondary text-white': 'text-black-50'}`}>
                    Nearshore
              ...
              <div className="form-boxes">
                ...
                <div>
                  <label htmlFor="online"
                         className={`border rounded px-2 cursor-pointer ${findElement('En ligne', catalogue.moyen) ? 'bg-secondary text-white': 'text-black-50'}`}>
                    En ligne
                ...
                <div>
                  <label htmlFor="magasin"
                         className={`border rounded px-2 cursor-pointer ${findElement('En magasin', catalogue.moyen) ? 'bg-secondary text-white': 'text-black-50'}`}>
                    En magasin
                ...
                <div>
                  <label htmlFor="usine"
                         className={`border rounded px-2 cursor-pointer ${findElement('En usine', catalogue.moyen) ? 'bg-secondary text-white': 'text-black-50'}`}>
                    En usine
              ...
              <div className="form-boxes">
                ...
                <div>
                  <label htmlFor="detaillant"
                         className={`border rounded px-2 cursor-pointer ${findElement('Détaillant', catalogue.type_vente) ? 'bg-secondary text-white': 'text-black-50'}`}>
                    Détaillant
                ...
                <div>
                  <label htmlFor="grossiste"
                         className={`border rounded px-2 cursor-pointer ${findElement('Grossiste', catalogue.type_vente) ? 'bg-secondary text-white': 'text-black-50'}`}>
                    Grossiste
              ...
              <div className="form-boxes">
                ...
                <div>
                  <label htmlFor="importes"
                         className={`border rounded px-2 cursor-pointer ${findElement('Importés', catalogue.produit_achete) ? 'bg-secondary text-white': 'text-black-50'}`}>
                    Importés
                ...
                <div>
                  <label htmlFor="locaux"
                         className={`border rounded px-2 cursor-pointer ${findElement('Locaux', catalogue.produit_achete) ? 'bg-secondary text-white': 'text-black-50'}`}>
                    Locaux
              ...
              <div className="form-boxes">
                ...
                <div>
                  <label htmlFor="local"
                         className={`border rounded px-2 cursor-pointer ${findElement('Local', catalogue.distribution) ? 'bg-secondary text-white': 'text-black-50'}`}>
                    Local
                ...
                <div>
                  <label htmlFor="export"
                         className={`border rounded px-2 cursor-pointer ${findElement('Export', catalogue.distribution) ? 'bg-secondary text-white': 'text-black-50'}`}>
                    Export
