              ...
              <div className="col-12 col-md-9">
                <div className="row mb-4 mt-2 ">
                  <div className="d-flex  flex-wrap position-relative">
                    ...
                    <div
                      className={
                        tab == 3 ? "xfg xfg-clicked  position-relative" : "xfg"
                      }
                      onClick={() => setTab(3)}
                    >
                      {" "}
                    ...
                    <div
                      className={
                        tab == 4 ? "xfg xfg-clicked  position-relative" : "xfg"
                      }
                      onClick={() => setTab(4)}
                    >
                    ...
                    <div
                      className={
                        tab == 5 ? "xfg xfg-clicked  position-relative" : "xfg"
                      }
                      onClick={() => setTab(5)}
                    >
                    ...
                    <div
                      className={
                        tab == 6 ? "xfg xfg-clicked  position-relative" : "xfg"
                      }
                      onClick={() => setTab(6)}
                    >
                    ...
                    <div
                      className={
                        tab == 7 ? "xfg xfg-clicked  position-relative" : "xfg"
                      }
                      onClick={() => setTab(7)}
                    >
                    ...
                    <div
                      className={
                        tab == 8 ? "xfg xfg-clicked  position-relative" : "xfg"
                      }
                      onClick={() => setTab(8)}
                    >
                    ...
                    <div
                      className={
                        tab == 9 ? "xfg xfg-clicked  position-relative" : "xfg"
                      }
                      onClick={() => setTab(9)}
                      style={{ marginRight: "0" }}
                    >
