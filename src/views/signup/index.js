...
import FormUserPrivacy from '../../components/form-company'; // load component
        ...
        <section>
          ...
          <LazyLoad once>
            <div className="progressbar">
              ...
              <div className={pageStage===2 ? 'progress-step progress-step-active' : 'progress-step'} data-title="Company"></div>
